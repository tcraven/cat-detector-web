    ...
    return (
        <div>
            ...
            <p>The Cat Detector is an IoT application that uses machine learning to
                detect cats in a Raspberry Pi camera. Potential use cases include
                keeping your cats off the kitchen counter or away from houseplants.
                The application consists of two components - an
                IoT application running on the Pi, and a website hosted in the cloud.</p>

            <h3>Raspberry Pi IoT Application</h3>
            <p>The Cat Detector is an <a href="https://docs.aws.amazon.com/greengrass/v2/developerguide/what-is-iot-greengrass.html" target="_blank" rel="noreferrer">AWS IoT Greengrass</a> application
                that runs continuously
                on the Pi as a set of background processes. It has the following
                components:</p>

            <h4>Greengrass Nucleus</h4>
            <p>The main controller for the other components is <a href="https://docs.aws.amazon.com/greengrass/v2/developerguide/greengrass-nucleus-component.html" target="_blank" rel="noreferrer">AWS IoT Greengrass Nucleus</a>. This is a standard AWS IoT Greengrass
            ...
            <p>The WebRTC Client component accepts WebRTC calls from the Website video player
                via the <a href="https://aws.amazon.com/kinesis/video-streams/" target="_blank" rel="noreferrer">AWS Kinesis video service</a>.
                When a call is started, it starts its own
            ...
            <p>The component is a C application, based on an example application from
                the <a href="https://docs.aws.amazon.com/kinesisvideostreams-webrtc-dg/latest/devguide/kvswebrtc-sdk-c.html" target="_blank" rel="noreferrer">AWS Kinesis WebRTC C SDK</a>.
                When a call ends, the component releases its
            ...
            <p>This component is responsible for detecting cats in the video. It is a Python
                ...
                and if a cat is detected, a message is published to an <a href="https://docs.aws.amazon.com/iot/latest/developerguide/topics.html" target="_blank" rel="noreferrer">IoT MQTT topic</a> and to
                an internal <a href="https://docs.aws.amazon.com/greengrass/v2/developerguide/ipc-publish-subscribe.html" target="_blank" rel="noreferrer">Greengrass IPC topic</a>. These messages are picked up by the Website
                and Audio Player component respectively.</p>
            <p>The machine learning model used is a pre-trained ResNet50 model running on the <a href="https://pytorch.org/vision/stable/index.html" target="_blank" rel="noreferrer">PyTorch Torchvision</a> library. Each classification takes approximately 2.5
                seconds to run on the Pi, and only one classification runs at a time. This
                means that one in every three video frames is classified, and there is a
                delay of approximately five seconds between the cat being put in the Pi camera
                view, and the publishing of the detection message.</p>
            ...
            <p>The Audio Player component is responsible for playing a short audio clip each
                ...
                plugged into the Pi headphones jack.</p>

            <h3>Cloud Components</h3>

            <h4>Website</h4>
            <p>The website is a static web application written in React. It uses the <a href="https://aws.amazon.com/amplify/" target="_blank" rel="noreferrer">AWS Amplify SDK</a> and <a href="https://docs.aws.amazon.com/kinesisvideostreams-webrtc-dg/latest/devguide/kvswebrtc-sdk-js.html" target="_blank" rel="noreferrer">AWS Kinesis WebRTC SDK</a> libraries, and is hosted via Github Pages.</p>
            ...
            <ul>
                ...
                <li>
                    <p>Users are authenticated using <a href="https://aws.amazon.com/pm/cognito" target="_blank" rel="noreferrer">AWS Cognito</a>, and must sign in via a Cognito
                ...
                <li>
                    <p>An information section displays instructions how to use the demo,
                        ...
                        and information about AWS IoT Consulting Partner Cardinal Peak</p>
                </li>
            </ul>
            ...
            <p>The initial set-up and configuration of the Pi, and subsequent component
                ...
                Console and running local <a href="https://docs.aws.amazon.com/greengrass/v2/developerguide/gg-cli-reference.html" target="_blank" rel="noreferrer">Greengrass CLI commands</a>.</p>
            ...
            <h4>AWS Cognito</h4>
            <p>User authentication is handled by AWS Cognito. A User Pool is configured to
